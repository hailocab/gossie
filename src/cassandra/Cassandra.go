...
type Cassandra interface {
	...
	//  - ItemId
	//  - Values
	ExecutePreparedCqlQuery(itemId int32, values []string) (r *CqlResult_, err error)
}
...
//  - ItemId
//  - Values
func (p *CassandraClient) ExecutePreparedCqlQuery(itemId int32, values []string) (r *CqlResult_, err error) {
...
func NewCassandraProcessor(handler Cassandra) *CassandraProcessor {
	...
	self92 := &CassandraProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self92.processorMap["login"] = &cassandraProcessorLogin{handler: handler}
	self92.processorMap["set_keyspace"] = &cassandraProcessorSetKeyspace{handler: handler}
	self92.processorMap["get"] = &cassandraProcessorGet{handler: handler}
	self92.processorMap["get_slice"] = &cassandraProcessorGetSlice{handler: handler}
	self92.processorMap["get_count"] = &cassandraProcessorGetCount{handler: handler}
	self92.processorMap["multiget_slice"] = &cassandraProcessorMultigetSlice{handler: handler}
	self92.processorMap["multiget_count"] = &cassandraProcessorMultigetCount{handler: handler}
	self92.processorMap["get_range_slices"] = &cassandraProcessorGetRangeSlices{handler: handler}
	self92.processorMap["get_indexed_slices"] = &cassandraProcessorGetIndexedSlices{handler: handler}
	self92.processorMap["insert"] = &cassandraProcessorInsert{handler: handler}
	self92.processorMap["add"] = &cassandraProcessorAdd{handler: handler}
	self92.processorMap["remove"] = &cassandraProcessorRemove{handler: handler}
	self92.processorMap["remove_counter"] = &cassandraProcessorRemoveCounter{handler: handler}
	self92.processorMap["batch_mutate"] = &cassandraProcessorBatchMutate{handler: handler}
	self92.processorMap["truncate"] = &cassandraProcessorTruncate{handler: handler}
	self92.processorMap["describe_schema_versions"] = &cassandraProcessorDescribeSchemaVersions{handler: handler}
	self92.processorMap["describe_keyspaces"] = &cassandraProcessorDescribeKeyspaces{handler: handler}
	self92.processorMap["describe_cluster_name"] = &cassandraProcessorDescribeClusterName{handler: handler}
	self92.processorMap["describe_version"] = &cassandraProcessorDescribeVersion{handler: handler}
	self92.processorMap["describe_ring"] = &cassandraProcessorDescribeRing{handler: handler}
	self92.processorMap["describe_partitioner"] = &cassandraProcessorDescribePartitioner{handler: handler}
	self92.processorMap["describe_snitch"] = &cassandraProcessorDescribeSnitch{handler: handler}
	self92.processorMap["describe_keyspace"] = &cassandraProcessorDescribeKeyspace{handler: handler}
	self92.processorMap["describe_splits"] = &cassandraProcessorDescribeSplits{handler: handler}
	self92.processorMap["system_add_column_family"] = &cassandraProcessorSystemAddColumnFamily{handler: handler}
	self92.processorMap["system_drop_column_family"] = &cassandraProcessorSystemDropColumnFamily{handler: handler}
	self92.processorMap["system_add_keyspace"] = &cassandraProcessorSystemAddKeyspace{handler: handler}
	self92.processorMap["system_drop_keyspace"] = &cassandraProcessorSystemDropKeyspace{handler: handler}
	self92.processorMap["system_update_keyspace"] = &cassandraProcessorSystemUpdateKeyspace{handler: handler}
	self92.processorMap["system_update_column_family"] = &cassandraProcessorSystemUpdateColumnFamily{handler: handler}
	self92.processorMap["execute_cql_query"] = &cassandraProcessorExecuteCqlQuery{handler: handler}
	self92.processorMap["prepare_cql_query"] = &cassandraProcessorPrepareCqlQuery{handler: handler}
	self92.processorMap["execute_prepared_cql_query"] = &cassandraProcessorExecutePreparedCqlQuery{handler: handler}
	return self92
}
...
func (p *cassandraProcessorGetRangeSlices) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval []*KeySlice
	var err2 error
	if retval, err2 = p.handler.GetRangeSlices(args.ColumnParent, args.Predicate, args.RangeA1, args.ConsistencyLevel); err2 != nil {
		switch v := err2.(type) {
		case *InvalidRequestException:
			result.Ire = v
		case *UnavailableException:
	...
	for i := 0; i < size; i++ {
		...
		for i := 0; i < size; i++ {
			...
			if err := _elem98.Read(iprot); err != nil {
				return fmt.Errorf("%T error reading struct: %s", _elem98, err)
			}
			_val97 = append(_val97, _elem98)
		}
		if err := iprot.ReadListEnd(); err != nil {
			return fmt.Errorf("error reading list end: %s", err)
		}
...
func (p *GetRangeSlicesResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		if err := _elem102.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem102, err)
		}
		...
		for i := 0; i < size; i++ {
			...
			for i := 0; i < size; i++ {
				...
				if err := _elem108.Read(iprot); err != nil {
					return fmt.Errorf("%T error reading struct: %s", _elem108, err)
				}
				_val107 = append(_val107, _elem108)
			}
			if err := iprot.ReadListEnd(); err != nil {
				return fmt.Errorf("error reading list end: %s", err)
			}
			_val105[_key106] = _val107
		}
		if err := iprot.ReadMapEnd(); err != nil {
			return fmt.Errorf("error reading map end: %s", err)
		}
		p.MutationMap[_key104] = _val105
	}
	if err := iprot.ReadMapEnd(); err != nil {
		return fmt.Errorf("error reading map end: %s", err)
	}
...
func (p *DescribeSchemaVersionsResult) ReadField0(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		for i := 0; i < size; i++ {
			...
			_val110 = append(_val110, _elem111)
		}
		if err := iprot.ReadListEnd(); err != nil {
			return fmt.Errorf("error reading list end: %s", err)
		}
...
type ExecutePreparedCqlQueryArgs struct {
	...
	Values []string `thrift:"values,2,required" json:"values"`
}
...
func (p *ExecutePreparedCqlQueryArgs) GetValues() []string {
	return p.Values
}
...
func (p *ExecutePreparedCqlQueryArgs) ReadField2(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Values = append(p.Values, _elem115)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return fmt.Errorf("error reading list end: %s", err)
	}
